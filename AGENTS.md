...
Use `dart-book-distillation` skill when the user wants to distill a Dart/Flutter book into executable skills. Trigger: "拆书" / "蒸馏" / "把 XX 书做成 skill" / "distill this book".

Requirements before starting:
- Book text source (PDF/EPUB/TXT) — never distill from memory
- Book title + author + publication year
- Confirm with user before proceeding through stages

Output goes to `books/<book-slug>/` with BOOK_OVERVIEW.md, INDEX.md, candidates/, rejected/, and skill SKILL.md files.
